...
const SuperAdmin = () => {
  ...
  const toggleStatus = async (id, currentStatus) => {
    ...
    setTenants(tenants.map(t => t.id === id ? { ...t, is_active: !t.is_active } : t)); // Optimistic
  ...
  const filteredTenants = tenants.filter(t => {
    ...
    const matchesSearch = (t.hotel_settings?.hotel_name || t.username).toLowerCase().includes(term) ||
